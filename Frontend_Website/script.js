...
const API_URL = "http://127.0.0.1:8000/validate";
...
async function uploadImage() {
  ...
  // Save query thumbnail before showing results
...
function displayResults(data) {
  ...
  images.forEach((img, index) => {
    ...
    // Build image element — show placeholder if no URL provided
...
function showInlineError(msg) {
  // Small toast-like feedback on the drop zone
